...
export const LESSONS: any = {
    ...
    3: {
        id: 3,
        description:
            'Component @Input - How To Pass Input Data To an  Component',
        duration: '2:33',
        seqNo: 3,
        courseId: 5,
    },
    4: {
        id: 4,
        description:
            ' Component Events - Using @Output to create custom events',
        duration: '4:44',
        seqNo: 4,
        courseId: 5,
    },
    ...
    6: {
        id: 6,
        description:
            'Styling  Components - Learn About Component Style Isolation',
        duration: '3:27',
        seqNo: 6,
        courseId: 5,
    },
    ...
    8: {
        id: 8,
        description:
            ' Components Tutorial For Beginners - Components Exercise !',
        duration: '1:26',
        seqNo: 8,
        courseId: 5,
    },
    ...
    53: {
        id: 53,
        description:
            "Custom Global Events - Why Don't They Scale In Complexity?",
        duration: '7:47',
        seqNo: 4,
        courseId: 4,
    },
    ...
    55: {
        id: 55,
        description:
            'Unidirectional Data Flow And The Angular Development Mode',
        duration: '7:07',
        seqNo: 6,
        courseId: 4,
    },
